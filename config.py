...
MINES = 15 # 10-20
CELL_SIZE = 40
GAME_STATE_OBJ_SIZE = 150
COL_LABEL_SIZE = 40
EXTRA_HEIGHT = 150 # Pixels of padding on the bottom
EXTRA_WIDTH = 100
WIDTH = COLS * CELL_SIZE + COL_LABEL_SIZE + EXTRA_WIDTH
HEIGHT = ROWS * CELL_SIZE + GAME_STATE_OBJ_SIZE + EXTRA_HEIGHT
